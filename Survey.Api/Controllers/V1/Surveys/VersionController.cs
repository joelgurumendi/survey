...
namespace Surveys.Api.Controllers.V1.Surveys
{
    ...
    public class VersionController : ControllerBase
    {
        ...
        public VersionController(IMediator mediator, IHttpContextAccessor context)
        {
            _mediator = mediator;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateVersionCommand command, CancellationToken cancellationToken)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(UpdateVersionCommand command, CancellationToken cancellationToken)
        {
            try
            {
        ...
        public async Task<IActionResult> Delete(Guid id, CancellationToken cancellationToken)
        {
            ...
            var command = new DeleteVersionCommand { Id = id, CreatedBy = _userId, Role = _role };
            try
            {
                await _mediator.Send(command, cancellationToken);
                var response = new OKResponse();
